<template>
    <div class="accordion" :class="{ 'accordion--opened': accordionActive }">
        <div class="accordion__head" @click.stop="changeTab">
...
export default class ComponentCareerAccordion extends mixins(mixinAccordion) {
    @Prop()
    public index!: number;
    ...
    public changeTab() {
        ...
        this.$emit('change', this.index, this.accordionActive);
    }
}
</script>
